...
# 231214 omitted bc empty, 231213 omitted bc its rly messed up idk

setwd("/Users/Serena/Desktop/JCC/Git/RawData/CaseC")

file_names <- c("231115.csv","231116.csv","231120.csv","231121.csv",
                "231123.csv","231128.csv","231129.csv","231204.csv",
                "231207.csv","231208.csv","231212.csv")
...
setwd("/Users/Serena/Desktop/JCC/GY.112183")
...
ctrlpts <- read.csv("GY_CtrlPts.csv")
...
write.csv(finalTable90270, "/Users/Serena/Desktop/JCC/Git/CleanData/CleanC.csv", row.names=FALSE)
